...
df_latlong["latitud"] <- sapply(df_latlong$latitud, function(l) ifelse(l >= 40.3093, "North", "South"))

df_latlong["longitud"] <- sapply(df_latlong$longitud, function(l) ifelse(l >= -3.6842, "East", "West"))
...
ggplot(df_latlong, aes(x = latitud, fill=latitud)) +
  ...
  geom_text(aes(label = round(..count../ nrow(df_latlong), 2)), stat = "count", vjust = 4, colour = "black") + 
